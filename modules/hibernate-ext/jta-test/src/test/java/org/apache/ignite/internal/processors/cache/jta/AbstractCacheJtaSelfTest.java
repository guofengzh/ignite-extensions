...
import org.apache.ignite.internal.processors.cache.TxLogConfig;
...
public abstract class AbstractCacheJtaSelfTest extends GridCacheAbstractSelfTest {
    ...
    public static final TransactionManager transactionManager =  com.arjuna.ats.jta.TransactionManager.transactionManager();
    public static final UserTransaction userTransaction = com.arjuna.ats.jta.UserTransaction.userTransaction();

    /** {@inheritDoc} */
    @Override protected void beforeTestsStarted() throws Exception {
        super.beforeTestsStarted();
        TxLogConfig.setTxLogDir();
    }
    ...
    public void testJta() throws Exception {
        UserTransaction jtaTx = userTransaction;
